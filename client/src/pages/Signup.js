...
const Signup = (props) => {
  ...
  const handleSubmit = (e) => {
    ...
    const invalidFormSubmission =
      formState.username.isValid === false ||
    ...
    if (!invalidFormSubmission) {
      ...
      axios
        .post(`http://${url}/auth/createaccount/`, user, {
          headers: {
      ...
      <form className="signupForm">
        ...
        <Grid className="signupInput">
          <TextField
            ...
            helperText={
              errorMsgs.email && 'You need to submit a valid email address'
            }
        ...
        <StyledFormHelperText>{signupError}</StyledFormHelperText>
        <StyledButton
          className="createBtn"
